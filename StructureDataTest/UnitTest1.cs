...
namespace StructureDataTest
{
    public class Tests
    {
        ...
        [TestCase(new int[] { 1, 2, 3, 4 }, 2, -1, new int[] { 1, 2, -1, 3, 4 })]
        [TestCase(new int[] { 1, 2, 3, 4 }, 4, -1, new int[] { 1, 2, 3, 4, -1 })]
        [TestCase(new int[] { 1, 2, 3, 4, 5 }, 1, 6, new int[] { 1, 6, 2, 3, 4, 5 })]
        public void AddValueByIndexTest(int[] array, int index, int value, int[] expArray)
        {
            ArrayList expected = new ArrayList(expArray);
            ArrayList actual = new ArrayList(array);
        ...
        public void thisTest()
        {
            ...
            Assert.Throws<IndexOutOfRangeException>(() => arrayList[5] = 6);
        }
        ...
        public void AddNewArrayToCurrentArrayInTheEndTest(int[] array1, int[] array2, int[] expArray)
        {
            ...
            ArrayList actual2 = new ArrayList(array2);

            actual.AddNewArrayToCurrentArrayInTheEnd(actual2);
        ...
        public void AddNewArrayToCurrentArrayInTheBeginningTest(int[] array1, int[] array2, int[] expArray)
        {
            ...
            actual.AddNewArrayToCurrentArrayInTheBeginning(actual2);
        ...
        public void AddNewArrayToCurrentArrayByTheIndexTest(int[] array1, int index, int[] array2, int[] expArray)
        {
            ...
            actual.AddNewArrayToCurrentArrayByTheIndex(index, actual2);
